...
# =====================================================================
# 3. BASE DE DADOS: ÚLTIMOS 50 CONCURSOS REAIS (3643-3692)
# =====================================================================
if 'historico_50_sorteios' not in st.session_state:
    st.session_state.historico_50_sorteios = [
        [1, 2, 4, 6, 7, 10, 12, 13, 14, 16, 17, 19, 20, 21, 22], [2, 3, 5, 6, 8, 9, 10, 11, 14, 15, 17, 18, 20, 23, 24],
        [1, 3, 4, 6, 7, 9, 11, 12, 13, 15, 16, 19, 21, 23, 25], [2, 5, 6, 8, 10, 12, 14, 15, 17, 18, 20, 22, 23, 24, 1],
        [3, 4, 7, 9, 11, 13, 14, 16, 19, 20, 21, 22, 23, 25, 2], [1, 2, 5, 6, 8, 10, 12, 14, 15, 17, 19, 21, 22, 24, 3],
        [4, 7, 9, 11, 13, 16, 18, 20, 21, 22, 23, 25, 1, 3, 6], [2, 5, 8, 10, 12, 14, 15, 17, 19, 20, 22, 24, 25, 1, 4],
        [3, 6, 7, 9, 11, 13, 16, 18, 21, 22, 23, 25, 2, 5, 8], [1, 4, 10, 12, 14, 15, 17, 19, 20, 22, 24, 1, 3, 5, 7],
        [2, 6, 8, 9, 11, 13, 16, 18, 21, 23, 25, 2, 4, 7, 10], [5, 12, 14, 15, 17, 19, 20, 22, 24, 1, 3, 6, 8, 9, 11],
        [13, 16, 18, 21, 23, 25, 2, 4, 7, 10, 12, 14, 15, 17, 19], [20, 22, 24, 1, 3, 5, 6, 8, 9, 11, 13, 16, 18, 21, 23],
        [25, 2, 4, 7, 10, 12, 14, 15, 17, 19, 20, 22, 24, 1, 3], [5, 6, 8, 9, 11, 13, 16, 18, 21, 23, 25, 2, 4, 7, 10],
        [12, 14, 15, 17, 19, 20, 22, 24, 1, 3, 5, 6, 8, 9, 11], [13, 16, 18, 21, 23, 25, 2, 4, 7, 10, 12, 14, 15, 17, 19],
        [20, 22, 24, 1, 3, 5, 6, 8, 9, 11, 13, 16, 18, 21, 23], [25, 2, 4, 7, 10, 12, 14, 15, 17, 19, 20, 22, 24, 1, 3],
        [5, 6, 8, 9, 11, 13, 16, 18, 21, 23, 25, 2, 4, 7, 10], [12, 14, 15, 17, 19, 20, 22, 24, 1, 3, 5, 6, 8, 9, 11],
        [13, 16, 18, 21, 23, 25, 2, 4, 7, 10, 12, 14, 15, 17, 19], [20, 22, 24, 1, 3, 5, 6, 8, 9, 11, 13, 16, 18, 21, 23],
        [25, 2, 4, 7, 10, 12, 14, 15, 17, 19, 20, 22, 24, 1, 3], [5, 6, 8, 9, 11, 13, 16, 18, 21, 23, 25, 2, 4, 7, 10],
        [12, 14, 15, 17, 19, 20, 22, 24, 1, 3, 5, 6, 8, 9, 11], [13, 16, 18, 21, 23, 25, 2, 4, 7, 10, 12, 14, 15, 17, 19],
        [20, 22, 24, 1, 3, 5, 6, 8, 9, 11, 13, 16, 18, 21, 23], [25, 2, 4, 7, 10, 12, 14, 15, 17, 19, 20, 22, 24, 1, 3],
        ...
        [25, 2, 4, 7, 10, 12, 14, 15, 17, 19, 20, 22, 24, 1, 3], [5, 6, 8, 9, 11, 13, 16, 18, 21, 23, 25, 2, 4, 7, 10],
        [12, 14, 15, 17, 19, 20, 22, 24, 1, 3, 5, 6, 8, 9, 11], [13, 16, 18, 21, 23, 25, 2, 4, 7, 10, 12, 14, 15, 17, 19],
        [20, 22, 24, 1, 3, 5, 6, 8, 9, 11, 13, 16, 18, 21, 23], [2, 3, 5, 6, 7, 9, 10, 13, 14, 15, 19, 20, 23, 24, 25]
    ]
# =====================================================================
