...
with abas[0]:
   ...
   if st.session_state.jogos_gerados and st.button("💾 SALVAR PARA CONFERIR"):
        ...
        # Define o próximo concurso alvo
        if res_existentes:
